...
permitidos = ["countryandlifee","countryandlifee","countryandlifee","countryandlifee","countryandlifee","countryandlifee"]
...
if __name__ == '__main__':
    administrador = os.environ.get('countryandlifee')
    bot_token = os.environ.get('5451786044:AAGQivmv1XzTXqH7WYq-VBx6IkWgeAuX7rk')
